...
_https = os.environ.get('HTTPS_REDIRECT', 'true').lower() == 'true'
SESSION_COOKIE_SECURE = not DEBUG and _https
CSRF_COOKIE_SECURE = not DEBUG and _https
SECURE_SSL_REDIRECT = not DEBUG and _https
SECURE_HSTS_SECONDS = 31536000 if (not DEBUG and _https) else 0
SECURE_HSTS_INCLUDE_SUBDOMAINS = not DEBUG and _https
SECURE_HSTS_PRELOAD = not DEBUG and _https
